...
class OpenRouterClient:
    ...
    async def send_message(self, messages: List[Dict[str, str]], output_format: str = "text", model: str = "deepseek", temperature: float = 0, max_tokens: int = 4000, system_prompt_enabled: bool = True) -> Optional[Dict[str, any]]:
        try:
            chat_messages = []
